 ...
 *
 * Stores [ParsedStreamCollection.namesJson] verbatim and resolves no locale: which name a user sees
 * depends on the app locale, which is known at the presentation edge and not here. That is what keeps
 * a newly delivered locale reaching the user without an app release.
 */
@Singleton
