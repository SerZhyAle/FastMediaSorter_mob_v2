...
/** Tracks last forced-recreate timestamp per SFTP resource key. S0067. */
@Singleton
class SftpRecreateTracker @Inject constructor() {
    ...
    fun keyForServer(server: String, port: Int): String = "sftp://$server:$port"
}
