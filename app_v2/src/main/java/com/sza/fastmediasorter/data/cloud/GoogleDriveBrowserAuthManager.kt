...
@Singleton
class GoogleDriveBrowserAuthManager @Inject constructor(
    ...
    fun hasActiveSession(): Boolean = activeCredential != null

    fun peekStoredAccountEmail(): String? = activeCredential?.accountEmail
