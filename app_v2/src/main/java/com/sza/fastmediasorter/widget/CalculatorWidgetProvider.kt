...
class CalculatorWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        fun updateAppWidget(
            ...
            val intent = CalculatorActivity.createIntent(context, fromWidget = true).apply {
            ...
            views.setOnClickPendingIntent(R.id.widget_calculator_container, pendingIntent)
            ...
            HomeWidgetAccent.applyIconTint(views, R.id.widget_calculator_icon, context, "calculator")
