...
object BackupMapper {
    ...
    fun toBackupSettings(settings: AppSettings): BackupSettings {
        return BackupSettings(
            ...
            enableFileDoOperations = settings.enableFileDoOperations,
            ...
            openVideoInFullscreen = settings.openVideoInFullscreen,
            ...
            nineZoneGridEnabled = settings.nineZoneGridEnabled,
            ...
            resourceTypeTabCollapsed = settings.resourceTypeTabCollapsed,
    ...
    fun toAppSettings(backup: BackupSettings, current: AppSettings, payloadVersion: Int): AppSettings {
        val flatRestored = current.copy(
            ...
            enableFileDoOperations = backup.enableFileDoOperations,
            ...
            openVideoInFullscreen = backup.openVideoInFullscreen,
            ...
            nineZoneGridEnabled = backup.nineZoneGridEnabled,
            ...
            resourceTypeTabCollapsed = backup.resourceTypeTabCollapsed,
