...
/**
 * S2093: the single declared list of watch settings, phone-module copy.
 *
 * Mirrored verbatim in `wear/../wear/domain/model/WearSettingsRegistry.kt` - the two must not drift.
