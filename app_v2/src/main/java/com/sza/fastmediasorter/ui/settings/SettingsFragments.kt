...
class GeneralSettingsFragment : Fragment() {
    ...
    private var _binding: com.sza.fastmediasorter.databinding.FragmentSettingsGeneralBinding? = null
    private val binding get() = _binding!!
    ...
    override fun onCreateView(
        ...
        _binding = com.sza.fastmediasorter.databinding.FragmentSettingsGeneralBinding.inflate(inflater, container, false)
        return binding.root
    }
    ...
    private fun setupViews() {
        ...
        binding.btnUserGuide.setOnClickListener {
            val intent = Intent(requireContext(), com.sza.fastmediasorter.ui.welcome.WelcomeActivity::class.java)
    ...
    private fun showLogDialog(fullLog: Boolean) {
        ...
        val dialogView = layoutInflater.inflate(
            com.sza.fastmediasorter.R.layout.dialog_log_view,
            null
        )
        val textView = dialogView.findViewById<TextView>(com.sza.fastmediasorter.R.id.tvLogText)
