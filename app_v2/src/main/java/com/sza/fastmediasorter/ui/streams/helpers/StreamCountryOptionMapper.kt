 ...
 * [Option]s for the searchable picker. RU/BY reuse the translation UI's custom image-flag contract via
...
object StreamCountryOptionMapper {
    ...
    fun countryOptions(countryCodes: List<String>): List<Option> =
        countryCodes.map { code ->
            ...
            val label = if (customFlag != null || flagEmoji.isBlank()) normalized else "$flagEmoji $normalized"
