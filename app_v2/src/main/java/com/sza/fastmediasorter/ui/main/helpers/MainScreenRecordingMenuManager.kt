 ...
 *
 * S0913: the item icon is ic_display - the same drawable the settings toggle row uses (str_icon on
 * rowScreenRecordingEnabled) - so the programs menu/panel entry reads as the same feature as its setting.
 */
