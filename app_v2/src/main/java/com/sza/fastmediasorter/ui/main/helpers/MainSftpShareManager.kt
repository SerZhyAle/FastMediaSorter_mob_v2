 ...
 * Kept out of [com.sza.fastmediasorter.ui.main.MainActivity] to respect its LOC ceiling.
 */
class MainSftpShareManager(private val activity: Activity) {

    /** [onConfirm] receives whether the exported file should embed the password. */
    fun show(resource: MediaResource, onConfirm: (includePassword: Boolean) -> Unit) {
        ...
        MaterialAlertDialogBuilder(activity)
            ...
            .setPositiveButton(R.string.sftp_share_export_action) { _, _ ->
                onConfirm(!omitPassword.isChecked)
            }
