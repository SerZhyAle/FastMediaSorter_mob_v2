...
class LinkUrlCanonicalizerTest {
    ...
    fun music_youtube_watch_normalised_to_www() {
        ...
        assertEquals("https://www.youtube.com/watch?v=abc123", rewritten)
    }
    ...
    fun music_youtube_preserves_list_param() {
        ...
        assertEquals("https://www.youtube.com/watch?v=abc123&list=RDxyz", rewritten)
    }
    ...
    fun shorts_preserves_timestamp_query() {
        ...
        assertEquals("https://www.youtube.com/watch?t=5&v=abc123", rewritten)
    }
    ...
    fun non_youtube_url_unchanged() {
        ...
        assertEquals(foreign, canonicalizer.canonicalize(foreign))
    }

    @Test
    fun malformed_url_unchanged() {
        val nonsense = "not a url"
        assertEquals(nonsense, canonicalizer.canonicalize(nonsense))
    }
    ...
    fun youtube_non_shorts_path_unchanged() {
        ...
        assertEquals(playlist, canonicalizer.canonicalize(playlist))
    }
