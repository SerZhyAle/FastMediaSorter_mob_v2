...
/**
 * S3347: the owner heard the siren as a tolerable beep at full channel volume, so the waveform is what
 * this ticket changes - and the RMS assertion below is the whole objective claim behind it.
 */
