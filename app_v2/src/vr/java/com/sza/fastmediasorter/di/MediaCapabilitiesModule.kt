...
object MediaCapabilitiesModule {
    ...
    fun provideMediaCapabilities(): MediaCapabilities = MediaCapabilities(
        ...
        // SUPPORT_IMMERSIVE_XR, not SUPPORT_VR_PLAYER: the latter is false on vr (S0241) while the
        // 3D tab must show on both flavors that mount src/vr. S2742 gave that reach its own flag.
        supportsVrMediaControls = BuildConfig.SUPPORT_IMMERSIVE_XR,
    )
}
