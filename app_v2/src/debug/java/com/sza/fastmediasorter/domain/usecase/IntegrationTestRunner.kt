...
class IntegrationTestRunner @Inject constructor(
    ...
    enum class TestGroup(val displayName: String) {
        ...
        // S0241: THREE_D_VR sweep removed together with the VR / OpenXR stack. The enum value
        // is retained to keep ordinals stable for any test result records persisted from
        // earlier builds; new collection runs never produce entries for it.
        @Suppress("unused")
        THREE_D_VR("3DVR Sweep - removed"),
    ...
    private suspend fun buildTestList(group: TestGroup = TestGroup.ALL): List<Test> {
        ...
        // S0241: 3DVR sweep removed together with the OpenXR / immersive VR stack.
        // The VrLaunchRoute / 3DVR routing helper classes no longer exist on the classpath.
    ...
    // S0241: 3DVR sweep helpers / data classes / manifest loader / per-test functions removed
    // together with the VR / OpenXR stack. ~243 lines deleted from this file.
