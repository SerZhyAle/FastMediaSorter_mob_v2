...
| **Lite** | Спрощена версія, лише локальні файли | Відео, Аудіо, Фото (без хмари, без документів) |
| **Photos** | Оптимізована для роботи з фотографіями + хмара | Лише зображення + хмарне сховище (без відео/аудіо) |
| **Legacy** | Повний функціонал для старих Android (6.0+) | Відео, Аудіо, Фото, Документи, EPUB, Хмарні сервіси |

### Яку версію вибрати?

- **Standard** ⭐ **(Рекомендується)**: Повний досвід з усіма функціями — хмарне сховище, перегляд документів, переклади, підтримка аудіо
- **Lite**: Менший розмір додатку, без хмари/документів/анімацій — фокус на локальних відео/аудіо/фото
- **Photos**: Краще для користувачів, які працюють тільки з зображеннями — включає підтримку хмарного резервного копіювання
- **Legacy**: Ідентичний набір функцій зі Standard, але підтримує Android 6.0+ (API 23)
...
- 🎛️ **Профілі ресурсів:** Швидке налаштування при створенні ресурсу (Аудіотека, Відеотека, Фотосховище, Документи, Всі файли) — автоматично задає фільтри типів файлів і порядок сортування за замовчуванням.
- 🔤 **Метадані: відображення та сортування:** Аудіофайли показують `Виконавець - Назва • Тривалість` у списку. Сортування за виконавцем, назвою, тривалістю або датою зйомки. Метадані кешуються разом зі списком файлів.
