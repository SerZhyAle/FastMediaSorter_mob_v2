...
## Devices & release
- [Test devices](reference_test_device_galaxy_s21.md) - S21+ ok, S20 FE is owner's phone · [adb CLI](reference_adb_swiss_army.md) + [.debug pkg](reference_adb_and_debug_package.md)
...
- [Emulator capture](reference_emulator_capture_family_testing.md) + [MediaProjection](reference_emulator_mediaprojection_capture.md)
...
- [VR inclusion hierarchy](project_vr_inclusion_hierarchy.md) · [supportsVrPlayer noLegal-only](project_supportsvrplayer_nolegal_only.md)
