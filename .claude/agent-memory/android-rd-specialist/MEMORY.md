...
- [Shrink the class, don't route around its ceiling](feedback_shrink_the_class_instead_of_routing_around_its_ceiling.md) - extract the repeated block so it fits
