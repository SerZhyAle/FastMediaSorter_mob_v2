...
- [API listing != public page](project_play_listing_api_vs_public_page.md) - API green, public page stale 8 days
...
- [Launcher desktop needs the full onboarding walk](feedback_launcher_desktop_device_test_setup.md) - HOME activity ships disabled, `pm enable` refused
...
- [Dialogs invisible under wm override](feedback_dialogs_invisible_under_wm_override.md) S1264 - use native geometry
- [Black screenshot = FLAG_SECURE](feedback_black_screenshot_means_flag_secure.md) S1284 - grep dumpsys `SECURE`
...
- [ChangeType Kotlin skips doc-pin gate](feedback_post_change_kotlin_skips_doc_pin_gate.md) - version bump closes on stale docs
...
- [Radio toggles: firmware bans, not targetSdk](project_radio_toggle_restriction_is_firmware_not_targetsdk.md) - direct path still works on Android 8
...
- [App self-pins shortcuts](project_app_self_pin_tests_launcher_pin_host.md) - tests the pin host end to end
...
- [Probe-measure poisons text centering](project_probe_measure_poisons_text_centering.md) S1258 - mh!=h
...
- [Shared-layout dialogs: fix the shared layer](feedback_shared_layout_fix_at_shared_layer.md) S1095 -> S1286 paid
...
- [Strategic spec owner gate](feedback_strategic_spec_owner_gate.md) · [UI placement refusal](feedback_spec_tech_ui_placement_refusal.md) - my §3.3 ≠ owner ruling · [spec-tech plan quality](feedback_spec_tech_plan_quality.md) · [Phase-boundary audit](feedback_phase_boundary_audit.md)
...
- [Concurrent /spec-all red tree](project_spec_all_concurrent_tree_red.md) - siblings share the tree, the locks and the emulator · [Frozen app? TracerPid](feedback_frozen_app_check_tracerpid.md)
...
- [ScheduleWakeup is /loop-only](feedback_schedulewakeup_loop_mode_only.md) - not for already-tracked bg tasks
