...
description: PowerShell Measure-Object -Line skips blank lines, so it silently undercounts LOC - use wc -l when a size threshold (1500, 600, 500) is the decision
metadata:
  type: feedback
---
...
**Why it matters here:** every size rule in this repo is a threshold on line count - Rule 2's 1500-LOC
