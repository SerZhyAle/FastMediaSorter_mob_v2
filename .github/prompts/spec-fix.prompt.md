---
mode: agent
description: "Use when: applying mechanical fixes after a spec-check audit, fixing FAIL/WARN items from the latest Last Audit block, asked to run /spec-fix. Triggers on: spec-fix, fix audit, fix spec failures, apply audit fixes."
---
