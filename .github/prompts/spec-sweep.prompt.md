---
agent: "agent"
description: "Use when: running an on-demand batch device-test sweep over active BlockNeedUserTest tickets to drain the manual-verification backlog, or asked to run /spec-sweep. Triggers on: spec sweep, batch device test, spec-sweep, emulator sweep."
---
