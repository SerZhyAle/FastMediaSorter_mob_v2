---
mode: agent
description: "Use when: auditing a spec against the actual codebase, checking if implementation matches spec, asked to run /spec-check. Triggers on: spec-check, audit spec, verify implementation, spec audit."
---
