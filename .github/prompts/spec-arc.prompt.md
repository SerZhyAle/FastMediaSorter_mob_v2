---
agent: "agent"
description: "Use when: archiving a specification - move PLAN/Sxxxx_* files to temp/done/ and mark the journal record Archived; or asked to run /spec-arc. Triggers on: archive spec, spec-arc, retire Sxxxx, declutter PLAN."
---
