---
agent: "agent"
description: "Use when: quickly investigating and fixing an existing bug, regression, crash, or small UI/logic issue without spec/doc/changelog/build/git bureaucracy; for fast code or user-interface patches; or asked to run /skill-fix. Triggers on: skill-fix, fast fix, quick bugfix, hotfix, patch bug, быстро исправь, быстро почини, почини баг."
---
...
```
/skill-fix <короткое описание проблемы>
```
