---
mode: agent
description: "Use when: user asks for caveman mode, fewer tokens, terse replies, ultra-brief communication, or asks to run /caveman. Triggers on: caveman, less tokens, terse, brief, compressed, minimal wording."
---
