---
mode: agent
description: "Use when: asked about git commits, how to stage files, what to commit, git diff analysis, pushing changes, researching old file versions, or asked to run /git command. Triggers on: git, commit, push, diff, stage, branch, what changed."
---
