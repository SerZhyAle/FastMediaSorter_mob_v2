...
- **Screen Off From Any Screen:** Opposite the back arrow, at the middle of the right edge, every screen that carries the arrow also carries a moon button that blanks the watch screen where you stand - no trip into a player first. A double tap, a press and hold, or the watch's own button brings the screen back, and a single tap while it is blank only marks the spot you touched. The button steps just inside the rim so it never sits on the volume bar or the scroll indicator that live there.
...
- [<img src="../icons/doc/ic_download.png" alt="" width="18" height="18" style="vertical-align:text-bottom"> **Direct APK Release**](../DOWNLOADS.md) - Direct APK downloads for phone and smartwatch sideloading.
