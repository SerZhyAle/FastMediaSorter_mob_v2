...
Флейвор `vr` - целевой канал для Meta Horizon Store. Иммерсивный рендеринг в нём уже подключён -
эпик S0773, который его построил, закрыт, - но из библиотеки шлема он пока открывает плоскую панель,
а не сразу VR, поэтому подавать его в магазин ещё нельзя (S0555) - см.
[Обзор VR-редакции](VR_EDITION-ru.md). Сегодня единственный канал, который входит в иммерсивный
режим сразу, - `noLegal`, его и ставит это руководство.
...
- [Обзор VR-редакции](VR_EDITION-ru.md) - что делает VR-редакция и чем отличается от стандартной
