...
{% include lang-switcher.html doc="scenario-camera-backup" dir="/docs/howto/" current="uk" %}
...
> **Не знаєте, яка у вас версія?** Відкрийте **Налаштування** <img src="../icons/doc/ic_settings.png" alt="" width="18" height="18" style="vertical-align:text-bottom"> → **Відомості про систему**. Рядок **Редакція** називає версію (Standard / Lite / тощо).
...
1. Відкрийте застосунок → натисніть **Додати <img src="../icons/doc/ic_add.png" alt="" width="18" height="18" style="vertical-align:text-bottom">** на панелі інструментів → виберіть **"Мережева папка (SMB)"**
...
1. Натисніть **Налаштування** (іконка шестерні <img src="../icons/doc/ic_settings.png" alt="" width="18" height="18" style="vertical-align:text-bottom"> на панелі інструментів)
2. Перейдіть на вкладку **Управління**
3. Прокрутіть до **"Заплановані операції за розкладом"** і натисніть **"Операції над файлами за розкладом"** - відкриється екран операцій за розкладом
4. Увімкніть **"Використовувати операції за розкладом"** угорі цього екрана
...
Натисніть кнопку **+** (**"Додати"**) на екрані операцій за розкладом.

Відкриється вікно нового розкладу.
...
1. Зайдіть у **Налаштування → Управління → Операції над файлами за розкладом**
2. Знайдіть свій розклад → натисніть **"Запустити"**
