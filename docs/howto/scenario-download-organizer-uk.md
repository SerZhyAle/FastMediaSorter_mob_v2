...
{% include lang-switcher.html doc="scenario-download-organizer" dir="/docs/howto/" current="uk" %}
...
2. Натисніть **Додати <img src="../icons/doc/ic_add.png" alt="" width="18" height="18" style="vertical-align:text-bottom">** на панелі інструментів
...
2. Натисніть кнопку **меню <img src="../icons/doc/ic_more_vert.png" alt="" width="18" height="18" style="vertical-align:text-bottom">** → **Створити папку**
...
2. Перейдіть на вкладку **Управління**
3. Прокрутіть до розділу **"Призначення швидкого сортування"**
...
1. Призначення - це ресурс, тому спершу додайте кожну папку-категорію на головному екрані: **Додати** → **"Локальна папка"** → оберіть папку (наприклад, `Робота`)
2. Поверніться до **Призначення швидкого сортування** і натисніть **"+ Додати"**
3. Оберіть папку в списку ваших ресурсів
...
1. Зайдіть у **Налаштування → вкладка Плеєр → Сенсорні зони й екранні підказки**
...
Зайдіть у **Налаштування → Управління → Переходити до наступного після копіювання** і увімкніть цей параметр.
...
> **Очистіть кошик після завершення:** Налаштування → Управління → Видалення файлів, кошик → Використовувати кошик (.trash) - натисніть поруч кнопку-кошик **"Видалити все в кошику"** для остаточного видалення файлів.
...
|---------|--------------|
| Не бачу пронумерованих кнопок | Налаштування → Управління → Призначення швидкого сортування - папки мають бути додані туди |
| Файл пішов не до тієї папки | Одразу натисніть **Скасувати** (протягом 5 секунд) |
| Хочу переміщати, а не копіювати | Переконайтеся, що **"Дозволити переміщення"** увімкнено в Налаштування → Управління, потім довго натискайте цифрову кнопку |
