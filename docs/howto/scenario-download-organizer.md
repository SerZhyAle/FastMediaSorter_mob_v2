...
**Real example:** you have 200 files in your Downloads folder - screenshots, work documents, family photos, memes, receipts. With Quick Sort you can sort all 200 in about 5 minutes. Without it - good luck.
...
The folder appears on the main screen as a card.

> **The Downloads folder is where your browser, Telegram, WhatsApp and other apps save files.** That's usually the messiest place on any phone.
...
Before setting up Quick Sort, decide what folders (categories) you want.

Think of it like physical folders on your desk. Examples:
- **Work** - documents, spreadsheets, PDFs from colleagues
- **Personal** - family photos, personal documents
- **Keep** - things worth saving long-term
- **Trash** - files to delete after reviewing
...
## Step 5 - Open a File to Sort

1. On the main screen, tap your **Downloads** resource
2. Files appear as a list - you see the file names and previews
3. Tap **any file** to open it full-screen

![Browse screen showing the Downloads folder file list](screenshots/screenshot-dl-step5.png)

---

## Step 6 - Sort It with One Tap

When a file is open full-screen, look at the **bottom of the screen** - you'll see a row of numbered colored buttons. Each button = one of your Quick Sort folders.

**To COPY a file to folder #1:**
- Tap the **"1" button** in the button row

**To MOVE a file to folder #1** (removes it from Downloads):
- **Long-press** the **"1" button** → select "Move"
- OR tap the **center zone** of the screen

The file is instantly sent to that folder - and the app **automatically jumps to the next file**. No need to go back. Just keep tapping numbers.

> **Copy vs. Move:** "Copy" keeps the original in Downloads AND puts a copy in the folder. "Move" sends the file to the folder and removes it from Downloads. For sorting/cleaning, "Move" is usually what you want.
...
## Step 7 - Turn On the Touch Zone Overlay (Recommended for Beginners)
...
## Step 8 - Enable Auto-Next (Makes Sorting Even Faster)
...
As you sort, tap the number button for each file:
- **Tap 1** → file goes to Work
- **Tap 2** → file goes to Personal
- **Tap 3** → file goes to Keep
- **Swipe down** → file goes to Trash (recoverable - it's not permanently deleted)
