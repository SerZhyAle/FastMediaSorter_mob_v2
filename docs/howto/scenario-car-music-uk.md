...
{% include lang-switcher.html doc="scenario-car-music" dir="/docs/howto/" current="uk" %}
...
> **Не можете знайти музику?** Натисніть **Додати <img src="../icons/doc/ic_add.png" alt="" width="18" height="18" style="vertical-align:text-bottom">** → **"Локальна папка"** і пошукайте папку з назвою `Music` в будь-якому місці списку. На більшості пристроїв вона знаходиться одразу.
...
2. Якщо її немає: натисніть **Додати <img src="../icons/doc/ic_add.png" alt="" width="18" height="18" style="vertical-align:text-bottom">** → прокрутіть до **Віртуальні ресурси** → оберіть **"Уся музика"**
...
> **Фонове відтворення:** щоб радіо продовжувало грати при перемиканні застосунків, зайдіть у **Налаштування → Плеєр → Фонове відтворення аудіо** і увімкніть його.

Примітка: Трансляції потребують підключення до мережі, а у версіях Lite і Photos екран Трансляцій відсутній.
...
| Радіо зупиняється при перемиканні застосунків | Зайдіть у Налаштування → Плеєр → Фонове відтворення аудіо і увімкніть його |
