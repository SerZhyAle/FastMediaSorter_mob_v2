...
{% include lang-switcher.html doc="scenario-photo-frame" dir="/docs/howto/" current="ru" %}
...
1. Нажмите **Добавить <img src="../icons/doc/ic_add.png" alt="" width="18" height="18" style="vertical-align:text-bottom">** → **Локальная папка** → перейдите в папку с фото → **Выбрать**

**Вариант Б - Домашний NAS / Windows ПК (SMB):**
1. Нажмите **Добавить <img src="../icons/doc/ic_add.png" alt="" width="18" height="18" style="vertical-align:text-bottom">** → **Сетевая папка (SMB)**
...
1. Нажмите **Добавить <img src="../icons/doc/ic_add.png" alt="" width="18" height="18" style="vertical-align:text-bottom">** → **Облачное хранилище** → выберите провайдера
...
Хотите, чтобы во время просмотра тихо играла музыка? Вот как (нужна версия с аудио - в Photos его нет):

1. Сначала добавьте источник музыки: **Добавить <img src="../icons/doc/ic_add.png" alt="" width="18" height="18" style="vertical-align:text-bottom">** → **Локальная папка** → папка с музыкой
2. Перейдите в **Настройки → вкладка Медиа → Аудио, обложки и фоновые визуализации**
3. Включите **"Показывать случайное фото при воспроизведении аудио"**

Затем **Настройки → вкладка Медиа → Изображения, GIF и слайд-шоу**:
4. Включите **"Музыка во время слайдшоу"**
5. Нажмите **"Выбрать источник музыки"** → выберите ресурс с музыкой
...
3. Нажмите **"Слайд-шоу" <img src="../icons/doc/ic_slideshow.png" alt="" width="18" height="18" style="vertical-align:text-bottom">** на панели инструментов
...
Перейдите в **Настройки → Управление → Запретить сон устройства** и включите.
...
4. При появлении запроса выберите фоторесурс
...
> **Фото с NAS не обновляются после добавления новых?** Приложение кэширует список файлов для скорости. Для обновления: вернитесь в папку → нажмите кнопку **Обновить <img src="../icons/doc/ic_refresh.png" alt="" width="18" height="18" style="vertical-align:text-bottom">** на панели инструментов. Новые фото появятся сразу.

> **Фото выглядят обрезанными или с чёрными полосами?** Откройте Настройки → Медиа → Изображения → **"Обрезать изображения на весь экран"** и попробуйте оба положения: ВЫКЛ сохраняет фото целиком, ВКЛ заполняет весь экран (небольшая обрезка по краям).
...
|---------|----------------|
| Экран гаснет через несколько минут | Включите "Запретить сон устройства" в Настройки → Управление (Шаг 5) **и** подключите USB-зарядку |
| Фото не отображаются | Откройте настройки папки (Шаг 2) и убедитесь, что в **Поддерживаемые типы** отмечены **Изображения** |
| Музыка не играет | Проверьте, что папка с музыкой содержит хотя бы один аудиофайл; проверьте, что в Настройки → Медиа → Изображения, GIF и слайд-шоу включена **"Музыка во время слайдшоу"** |
