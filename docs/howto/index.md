...
- <img src="../icons/doc/ic_cast.png" alt="" width="20" height="20" style="vertical-align:text-bottom"> _"I want to watch live TV channels on my smartwatch"_ → [TV on Your Smartwatch](scenario-watch-tv.md)
...
- <img src="../icons/doc/ic_cast.png" alt="" width="20" height="20" style="vertical-align:text-bottom"> _"Someone sent me a live broadcast link and I want to open it"_ → [Watch a Live Broadcast](watch-broadcast.md)
...
| [<img src="../icons/doc/ic_display.png" alt="" width="20" height="20" style="vertical-align:text-bottom"> Put FastMedia on Your Watch](wear-install.md) | Install FastMedia Wear on a Wear OS watch, switch the companion on in the phone settings and confirm both halves see each other | ~5 min | Wear OS (FastMedia Wear) |
...
| [<img src="../icons/doc/ic_cast.png" alt="" width="20" height="20" style="vertical-align:text-bottom"> TV on Your Smartwatch](scenario-watch-tv.md) | Watch live TV and radio channels on the wrist - fill the channel list, search and filter it, pin what you watch and reach it from a tile | ~10 min | Wear OS (FastMedia Wear) |
| [<img src="../icons/doc/ic_cast.png" alt="" width="20" height="20" style="vertical-align:text-bottom"> Internet Radio & Streams](scenario-internet-radio.md) | Play internet radio and IPTV streams on any Android device - add a URL, import an .m3u playlist, or pick from a curated catalog | ~10 min | Standard / Legacy / VR / noLegal |
| [<img src="../icons/doc/ic_cast.png" alt="" width="20" height="20" style="vertical-align:text-bottom"> Watch a Live Broadcast](watch-broadcast.md) | Open a broadcast someone is running from their phone or watch - on another Android phone, on a Wear OS watch, or in StreamsPlayer on Windows | ~3 min | Standard / Legacy / VR / noLegal |
