...
Флейвор `vr` - цільовий канал для Meta Horizon Store. Імерсивний рендеринг у ньому вже підключений -
епік S0773, який його побудував, закритий, - але з бібліотеки шолома він поки відкриває плоску панель,
а не одразу VR, тому подавати його в магазин ще не можна (S0555) - див.
[Огляд VR-редакції](VR_EDITION-uk.md). Сьогодні єдиний канал, який входить в імерсивний режим
одразу, - `noLegal`, його й встановлює цей посібник.
