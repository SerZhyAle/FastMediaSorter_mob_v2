...
на шоломі ще не підключений (епік S0773) - див. [Огляд VR-редакції](VR_EDITION-uk.md). Сьогодні
...
- [Огляд VR-редакції](VR_EDITION-uk.md) - що робить VR-редакція та чим відрізняється від стандартної
