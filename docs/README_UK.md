...
| **Lite** | Полегшений реліз | Менший розмір, базові медіасценарії та менше опціональних інтеграцій |
| **Photos** | Фото-орієнтований реліз | Оптимізований для перегляду, сортування та організації зображень |
| **Legacy** | Реліз для сумісності | Найкращий варіант для старих Android-пристроїв (API 23+), локальні медіа в пріоритеті |
...
- **Legacy**: Обирайте для старих Android-пристроїв (API 23+)
...
- 📱 **Підтримка віджетів:** Швидкий доступ до вибраних ресурсів прямо з домашнього екрана за допомогою двох типів віджетів: **Ярлик ресурсу** (миттєво відкриває будь-який збережений ресурс) і **Продовжити читання** (негайно запускає режим слайд-шоу).
