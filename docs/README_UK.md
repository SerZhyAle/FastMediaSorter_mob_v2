...
- 🏠 **Режим домашнього екрана:** Дозвольте застосунку стати домашнім екраном пристрою (збірки Standard і noLegal): власний робочий стіл з ярликами ресурсів, що відкриваються прямо в перегляд, слайд-шоу чи відтворення, гаджетами, що змінюють розмір, на кшталт годинника й погоди, комірками контактів без потреби в дозволі на контакти, сіткою застосунків і панеллю задач. Вимкніть будь-коли - і Android відновить попередній домашній екран.
