...
FastMediaSorter v2 виходить у **шести версіях**: чотири для повсякденних телефонів і планшетів (Standard, Lite, Photos, Legacy) плюс дві збірки для шоломів і sideload - VR і noLegal. Канонічна матриця можливостей генерується з файлу збірки: [FLAVOR_MATRIX.md](FLAVOR_MATRIX.md):
