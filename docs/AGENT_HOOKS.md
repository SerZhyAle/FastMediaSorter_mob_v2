...
|--------|---------|--------|---------|---------------|-------|
| `mobile-mcp` | Claude Code | `.mcp.json` | exploratory agent-driven device walks | `mobile_install_app`, `mobile_uninstall_app` | `guard-mcp-one-way-tools.ps1` |
| `maestro` | Claude Code | `.mcp.json` | exploratory device walks by selector (trial, S2918) | `run`, `run_on_cloud`, `list_cloud_devices`, `get_cloud_run_status` | `guard-mcp-one-way-tools.ps1` |
