...
- **Ресурс** - внутрішня сутність FastMediaSorter: зареєстрована адреса (локальна, мережева або хмарна), яку користувач додав вручну або імпортував. Ресурс може бути джерелом перегляду, отримувачем «Швидкого сортування», медіатекою або віртуальним агрегатом (Уся музика, Усі відео, обране, трансляції). Ресурс указує на одну теку або гілку тек. Використовуйте «ресурс», коли йдеться про зареєстрований запис застосунку: додати / змінити / копіювати / видалити / вибрати / оновити ресурс, його назву / тип / шлях / PIN, список ресурсів.
