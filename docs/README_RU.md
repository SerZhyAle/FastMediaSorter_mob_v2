...
| **Legacy** | Релиз для совместимости | Лучший вариант для старых Android-устройств (API 23+), локальные медиа в приоритете |
...
- **Legacy**: Выбирайте для старых Android-устройств (API 23+)
...
- 📱 **Поддержка виджетов:** Быстрый доступ к избранным ресурсам прямо с домашнего экрана с помощью двух типов виджетов: **Ярлык ресурса** (мгновенно открывает любой сохранённый ресурс) и **Продолжить чтение** (немедленно запускает режим слайд-шоу).
