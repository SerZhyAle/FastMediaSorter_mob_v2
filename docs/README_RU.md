...
FastMediaSorter v2 выходит в **шести версиях**: четыре для повседневных телефонов и планшетов (Standard, Lite, Photos, Legacy) плюс две сборки для шлемов и sideload - VR и noLegal. Каноническая матрица возможностей генерируется из файла сборки: [FLAVOR_MATRIX.md](FLAVOR_MATRIX.md):
