...
FastMediaSorter v2 доступен в **5 основных вариантах приложения** для телефонов, планшетов и XR-сценариев. Актуальная публичная матрица зафиксирована в [FEATURES_RU.md](FEATURES_RU.md) и [HOW_TO_RU.md](HOW_TO_RU.md):
...
| **Lite** | Облегчённый релиз | Меньший размер, базовые медиа-сценарии и меньше опциональных интеграций |
| **Photos** | Фото-ориентированный релиз | Оптимизирован для просмотра, сортировки и организации изображений |
| **Legacy** | Релиз для совместимости | Полный медиафункционал с SMB/FTP/SFTP и облаком (Google Drive, Dropbox, OneDrive); собран для Android 6/7 (API 23+) |
| **VR / noLegal** | XR и sideload-сборка | OpenXR / VR-capable путь для совместимых шлемов и sideload-only возможности |
...
- **VR / noLegal**: Используйте только если вам нужна XR-сборка для шлема или sideload-only surface
...
| **Legacy** | `FastMediaSorter_legacy_release.zip` | Медиа + сеть (SMB/FTP/SFTP) + облако; Android 6/7 (API 23+) |
