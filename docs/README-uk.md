...
**Виправлено:**
Нульові мініатюри, список ліцензій, що відкривається без затримки, усунення потоку голосових оголошень на екранах плеєра і мовлення, збереження розміру значків сітки та інтервалу фонової синхронізації, SOS і висота панелі завдань, що переживають відновлення з копії, повне покриття функції «Запобігти сну», коректне відновлення анімацій після заряджання, кнопки діалогів, що йдуть за мовою застосунку, і точна назва і бітрейт мовлення.
...
📄 [Як опублікувати теки ПК для Android](https://serzhyale.github.io/FastMediaSorter_Lite/publish-folders-android.html) - поділіться теками ПК із застосунком через SFTP (companion-імпорт / скан QR на телефоні).
...
FastMediaSorter v2 виходить у **семи версіях**: п'ять для повсякденних телефонів і планшетів (Standard, Lite, Photos, Legacy, FOSS) плюс дві збірки для шоломів і sideload - VR і noLegal. Канонічна матриця можливостей генерується з файлу збірки: [FLAVOR_MATRIX.md](FLAVOR_MATRIX.md):
...
- [How-To (таблиця доступності за версіями)](HOW_TO-uk.md)
- [Quick Start (вибір версії)](QUICK_START-uk.md)
...
- 🗣️ **Дії AppFunctions для асистента (Android 16+):** Застосунок оголошує дії, які може викликати системний асистент, - знайти медіафайл, відкрити файл або відкрити теку на комп'ютері, - щоб асистент вашого пристрою знаходив і відкривав ваш контент просто за голосовою командою.
...
- Перегляд і відтворення папок та обраного зі спареного телефону або власного сховища годинника безпосередньо на Wear OS пристроях
