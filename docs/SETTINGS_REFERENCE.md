...
| Show the left-edge gesture strip | Tints the left-edge gesture strip opaque grey so it is visible instead of transparent; takes effect only while the gesture overlay is enabled. |
