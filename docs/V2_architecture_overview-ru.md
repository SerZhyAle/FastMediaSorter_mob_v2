...
- Матрица вариантов: standard/legacy/noLegal/vr - полный набор (HLS, DASH VOD, RTSP, progressive HTTP/ICY, `SUPPORT_STREAMS=true`); lite/photos/foss - функция отсутствует, точки входа нет (`SUPPORT_STREAMS=false`, в lite скрыта в S0575; foss не содержит проприетарных SDK).
