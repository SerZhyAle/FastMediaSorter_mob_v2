...
**Область:** Усі видимі користувачу рядки в усіх шести флейворах (`standard`, `noLegal`, `lite`, `photos`, `legacy`, `vr`), EN/RU/UK. Виключення: юридичні тексти, Умови використання, машинно-читані технічні артефакти (маніфести, метадані).
