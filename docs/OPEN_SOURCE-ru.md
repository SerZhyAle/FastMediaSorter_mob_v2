...
FastMediaSorter собран на перечисленных ниже компонентах с открытым исходным кодом. Мы благодарны их авторам. Перечень формируется из файлов сборки, поэтому он покрывает всё, что входит в сборку, а не выборку.
...
| AndroidX CameraX Extensions | `androidx.camera:camera-extensions` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://android.googlesource.com/platform/frameworks/support/) |
| AndroidX CameraX Lifecycle | `androidx.camera:camera-lifecycle` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://android.googlesource.com/platform/frameworks/support/) |
| AndroidX CameraX Video | `androidx.camera:camera-video` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://android.googlesource.com/platform/frameworks/support/) |
| AndroidX CameraX View | `androidx.camera:camera-view` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://android.googlesource.com/platform/frameworks/support/) |
| Jetpack Compose Material Icons Core | `androidx.compose.material:material-icons-core` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://android.googlesource.com/platform/frameworks/support/) |
| Jetpack Compose Material Icons Extended | `androidx.compose.material:material-icons-extended` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://android.googlesource.com/platform/frameworks/support/) |
| Jetpack Compose Material 3 | `androidx.compose.material3:material3` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://android.googlesource.com/platform/frameworks/support/) |
| Jetpack Compose UI | `androidx.compose.ui:ui` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://android.googlesource.com/platform/frameworks/support/) |
| Jetpack Compose UI Graphics | `androidx.compose.ui:ui-graphics` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://android.googlesource.com/platform/frameworks/support/) |
| Jetpack Compose UI Tooling Preview | `androidx.compose.ui:ui-tooling-preview` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://android.googlesource.com/platform/frameworks/support/) |
| AndroidX Concurrent Futures KTX | `androidx.concurrent:concurrent-futures-ktx` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://android.googlesource.com/platform/frameworks/support/) |
...
| AndroidX Fragment KTX | `androidx.fragment:fragment-ktx` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://android.googlesource.com/platform/frameworks/support/) |
...
| AndroidX Hilt Navigation Compose | `androidx.hilt:hilt-navigation-compose` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://android.googlesource.com/platform/frameworks/support/) |
| AndroidX Hilt WorkManager | `androidx.hilt:hilt-work` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://android.googlesource.com/platform/frameworks/support/) |
| AndroidX Lifecycle LiveData KTX | `androidx.lifecycle:lifecycle-livedata-ktx` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://android.googlesource.com/platform/frameworks/support/) |
| AndroidX Lifecycle Process | `androidx.lifecycle:lifecycle-process` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://android.googlesource.com/platform/frameworks/support/) |
| AndroidX Lifecycle Runtime Compose | `androidx.lifecycle:lifecycle-runtime-compose` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://android.googlesource.com/platform/frameworks/support/) |
| AndroidX Lifecycle Runtime KTX | `androidx.lifecycle:lifecycle-runtime-ktx` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://android.googlesource.com/platform/frameworks/support/) |
| AndroidX Lifecycle ViewModel Compose | `androidx.lifecycle:lifecycle-viewmodel-compose` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://android.googlesource.com/platform/frameworks/support/) |
| AndroidX Lifecycle ViewModel KTX | `androidx.lifecycle:lifecycle-viewmodel-ktx` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://android.googlesource.com/platform/frameworks/support/) |
| AndroidX Media3 Common | `androidx.media3:media3-common` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://github.com/androidx/media) |
...
| AndroidX Media3 Inspector | `androidx.media3:media3-inspector` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://github.com/androidx/media) |
...
| AndroidX Paging Runtime KTX | `androidx.paging:paging-runtime-ktx` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://android.googlesource.com/platform/frameworks/support/) |
| AndroidX Print | `androidx.print:print` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://android.googlesource.com/platform/frameworks/support/) |
| AndroidX ProfileInstaller | `androidx.profileinstaller:profileinstaller` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://android.googlesource.com/platform/frameworks/support/) |
| AndroidX RecyclerView | `androidx.recyclerview:recyclerview` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://android.googlesource.com/platform/frameworks/support/) |
| AndroidX Room KTX | `androidx.room:room-ktx` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://android.googlesource.com/platform/frameworks/support/) |
| AndroidX Room Runtime | `androidx.room:room-runtime` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://android.googlesource.com/platform/frameworks/support/) |
| AndroidX Security Crypto | `androidx.security:security-crypto` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://android.googlesource.com/platform/frameworks/support/) |
| AndroidX SwipeRefreshLayout | `androidx.swiperefreshlayout:swiperefreshlayout` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://android.googlesource.com/platform/frameworks/support/) |
...
| Wear Compose Navigation | `androidx.wear.compose:compose-navigation` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://android.googlesource.com/platform/frameworks/support/) |
| AndroidX Wear ProtoLayout | `androidx.wear.protolayout:protolayout` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://android.googlesource.com/platform/frameworks/support/) |
| AndroidX Wear ProtoLayout Expression | `androidx.wear.protolayout:protolayout-expression` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://android.googlesource.com/platform/frameworks/support/) |
| AndroidX Wear ProtoLayout Material | `androidx.wear.protolayout:protolayout-material` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://android.googlesource.com/platform/frameworks/support/) |
| AndroidX Wear Tiles | `androidx.wear.tiles:tiles` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://android.googlesource.com/platform/frameworks/support/) |
...
| Gson | `com.google.code.gson:gson` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://github.com/google/gson) |
| Dagger Hilt Android | `com.google.dagger:hilt-android` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://github.com/google/dagger) |
...
| Apache Commons Net | `commons-net:commons-net` | [Apache-2.0](https://raw.githubusercontent.com/apache/commons-net/master/LICENSE.txt) | все сборки | [link](https://github.com/apache/commons-net) |
...
| Kotlin Coroutines Play Services | `org.jetbrains.kotlinx:kotlinx-coroutines-play-services` | [Apache-2.0](https://www.apache.org/licenses/LICENSE-2.0) | все сборки | [link](https://github.com/Kotlin/kotlinx.coroutines) |
...
Эти компоненты не являются открытым ПО. Они распространяются на условиях своих поставщиков и перечислены здесь потому, что входят в приложение.
