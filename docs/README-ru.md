...
- **Набор виджетов рабочего стола** - виджеты быстрого запуска и состояния для диктофона, OCR с камеры, задач по расписанию, текущего трека и фоторамки.
...
FastMediaSorter v2 выходит в **семи версиях**: пять для повседневных телефонов и планшетов (Standard, Lite, Photos, Legacy, FOSS) плюс две сборки для шлемов и sideload - VR и noLegal. Каноническая матрица возможностей генерируется из файла сборки: [FLAVOR_MATRIX.md](FLAVOR_MATRIX.md):

| Версия | Описание | Примечания |
|--------|----------|------------|
...
- [How-To (таблица доступности по версиям)](HOW_TO-ru.md)
- [Quick Start (выбор версии)](QUICK_START-ru.md)
