...
function Render-Doc([string] $locale, [string[]] $flavorScope, [bool] $isNoLegal) {
    ...
    [void]$sb.Append("# $($pageTitle[$locale])")
    if ($isNoLegal) { [void]$sb.Append(' (noLegal)') }
...
Write-Doc (Join-Path $OutDir 'SETTINGS_REFERENCE.md')    (Render-Doc 'en' $publishedFlavors $false)
Write-Doc (Join-Path $OutDir 'SETTINGS_REFERENCE_RU.md') (Render-Doc 'ru' $publishedFlavors $false)
Write-Doc (Join-Path $OutDir 'SETTINGS_REFERENCE_UK.md') (Render-Doc 'uk' $publishedFlavors $false)
# noLegal all-inclusive (gitignored)
Write-Doc (Join-Path $OutDir 'SETTINGS_REFERENCE_noLegal.md') (Render-Doc 'en' @('noLegal') $true)
