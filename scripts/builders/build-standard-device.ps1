...
# Start the Gradle build process
& $gradlew :app_v2:assembleStandardDebug "-Pchaquopy.enabled=false" --configuration-cache
...
Write-Host "`nStandard debug build launched successfully!" -ForegroundColor Green
