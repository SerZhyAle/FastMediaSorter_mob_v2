...
Enter-BuildLockOrExit -Reason "build-standard-release.ps1" -Domain Build.Phone
try {
...
$destName = "FastMediaSorter_standard_release.apk"
...
$logEntry = "$timestamp | standard-release | $destName"
