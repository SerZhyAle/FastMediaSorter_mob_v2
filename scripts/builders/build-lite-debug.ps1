...
# Start the Gradle build process
& $gradlew :app_v2:assembleLiteDebug "-Pchaquopy.enabled=false" --configuration-cache
...
Write-Host "Package name: com.sza.fastmediasorter.lite.debug" -ForegroundColor Cyan
...
$logEntry = "$timestamp | lite-debug | $destName"
