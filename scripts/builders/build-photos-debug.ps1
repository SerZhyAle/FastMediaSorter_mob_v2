...
Enter-BuildLockOrExit -Reason "build-photos-debug.ps1" -Domain Build.Phone
try {
...
Write-Host "Package name: com.sza.fastmediasorter.photos.debug" -ForegroundColor Cyan
...
$logEntry = "$timestamp | photos-debug | $destName"
