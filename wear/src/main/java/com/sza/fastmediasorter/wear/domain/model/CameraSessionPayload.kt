...
enum class CameraRefusal {
     ...
     *
     * Separate from [NOT_ASKED] because the two call for opposite remedies and this watch cannot tell
     * them apart on its own: it never learns which flavor the paired phone runs.
     */
