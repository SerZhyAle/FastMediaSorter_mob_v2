...
- [x] Phase 01: новые строки присутствуют в трёх locale, компилируются без ошибок
...
- [x] Phase 03: каждый класс исключения выдаёт отдельный Snackbar с локализованным текстом; ни один путь не использует хардкоженные английские строки
- [ ] Phase 04: после process death + возврат → либо файл сохранён, либо Snackbar "попытка не завершена"
- [x] Build: `assembleStandardDebug` без ошибок
- [x] Lint: `lintStandardDebug` без новых предупреждений в затронутых файлах
