...
<!-- Implemented 2026-05-01 — assembleStandardDebug PASS, FEATURES × 3 updated, catalog regenerated -->
**Date:** 2026-04-24
**Tier:** 3
...
- [ ] Quest 3: aim ray cursor turns blue when pointing at a UI button; reverts to white over video content (§2.1 F7).
- [ ] Quest 3: hover-enter audio cue audible on first frame the cursor enters an interactive View (§2.1 F8 / §3.5).
- [ ] Quest 3: pinch release plays `FX_KEYPRESS_RETURN`, distinct from press-down `FX_KEY_CLICK` (§2.1 F10).
