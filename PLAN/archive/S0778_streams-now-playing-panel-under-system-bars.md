# Стратегическая спецификация: S0778 - Панель streams now playing под системными элементами
...
**Tactical spec:** `PLAN/S0778_streams-now-playing-panel-under-system-bars/` (будет создан через `/spec-tech`)
...
Трансляции. Панель "что сейчас играет" появляется внизу но попадает под элементы операционной системы - недоступна для нажатия
...
Следующий шаг: `/spec-tech S0778` - создаст `PLAN/S0778_streams-now-playing-panel-under-system-bars/` с фазами.
