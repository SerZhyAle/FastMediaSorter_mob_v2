# Стратегическая спецификация: S0698 - Кнопка "программы" (три точки) шире в портретном виде
...
**Tactical spec:** `PLAN/S0698_wider-overflow-button-portrait/` (будет создан через `/spec-tech`)
...
сделать кнопку "программы" (три точки) в основном окне программы в 1.5 раза шире в портретном виде где у неё нет надписи)
...
Следующий шаг: `/spec-tech S0698` - создаст `PLAN/S0698_wider-overflow-button-portrait/` с фазами.
