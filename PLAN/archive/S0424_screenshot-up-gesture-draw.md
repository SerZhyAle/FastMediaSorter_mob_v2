# Стратегическая спецификация: S0424 - Жест вверх → открыть скриншот сразу в DRAW
...
**Tactical spec:** `PLAN/S0424_screenshot-up-gesture-draw/` (будет создан через `/spec-tech`)
...
Следующий шаг: `/spec-tech S0424` - создаст `PLAN/S0424_screenshot-up-gesture-draw/` с фазами.
