# Стратегическая спецификация: S0690 - Остановка проигрываемой трансляции повторным нажатием в списке
...
**Tactical spec:** `PLAN/S0690_stream-list-retap-stop/` (будет создан через `/spec-tech`)
...
Проигрывается музыкальная трансляция прямо в списке. По нажатии на неё же (когда она проигрывается) - СТОП
...
Следующий шаг: `/spec-tech S0690` - создаст `PLAN/S0690_stream-list-retap-stop/` с фазами.
