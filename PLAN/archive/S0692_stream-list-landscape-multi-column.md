# Стратегическая спецификация: S0692 - Больше одной колонки в списке трансляций в ландшафте
...
**Tactical spec:** `PLAN/S0692_stream-list-landscape-multi-column/` (будет создан через `/spec-tech`)
...
В ландшафте выводить в список трансляций больше одной колонки
...
Следующий шаг: `/spec-tech S0692` - создаст `PLAN/S0692_stream-list-landscape-multi-column/` с фазами.
