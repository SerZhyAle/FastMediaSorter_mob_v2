# Стратегическая спецификация: S0697 - Сохранение фильтра и сортировки списка трансляций между запусками
...
**Tactical spec:** `PLAN/S0697_stream-persist-filter-sort/` (будет создан через `/spec-tech`)
...
трансляцииСохранять отбор фильтр ми сортировку польователя для списка трансялций и возобновлять её при следующем запуске
...
Следующий шаг: `/spec-tech S0697` - создаст `PLAN/S0697_stream-persist-filter-sort/` с фазами.
