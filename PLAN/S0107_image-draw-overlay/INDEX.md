...
|---|-------|-----------|--------|------:|------|
| 01 | menu-entry | — | ⬜ Not started | 0/3 | [PHASE_01__menu-entry.md](PHASE_01__menu-entry.md) |
| 02 | draw-canvas-manager | 01 | ⬜ Not started | 0/5 | [PHASE_02__draw-canvas-manager.md](PHASE_02__draw-canvas-manager.md) |
| 03 | draw-toolbar-layout | 02 | ⬜ Not started | 0/4 | [PHASE_03__draw-toolbar-layout.md](PHASE_03__draw-toolbar-layout.md) |
| 04 | save-merge-flow | 02, 03 | ⬜ Not started | 0/5 | [PHASE_04__save-merge-flow.md](PHASE_04__save-merge-flow.md) |
...
- [ ] **Research:** Verify that `ImageLoadingManager` (or equivalent) exposes the currently loaded Bitmap for in-memory merge in Phase 04 without reloading. If it does not, Phase 04 needs an extra extraction step.
